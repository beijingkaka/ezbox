...
PKG_CLANG_SCAN_DIR ?= $(CLANG_SCAN_DIR)/$(PKG_NAME)$(if $(PKG_VERSION),-$(PKG_VERSION))
...
Build/Compile=$(if $(BUILD_SCAN),$(call Build/CompileScan/Default,),$(call Build/Compile/Default,))
